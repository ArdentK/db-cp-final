\begin{titlepage}
	...
	\noindent \begin{minipage}{0.13\textwidth}
		\includegraphics[width=\linewidth]{assets/bmstu_logo.png}
	\end{minipage}
	...
	\noindent\textnormal{Название:} \hspace{15mm} \underline{\textnormal{~~~~Конвейерные вычисления. Алгоритм Бойера -- Мура~~~~~}}\noindent
